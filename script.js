document.addEventListener("DOMContentLoaded", () => {
  ...
  const createElementModal = (element) => {
    ...
    const label =
      fullName ||
      wrapper.querySelector(".element-label, .modal-element-label").textContent;
    ...
    spotifyIcon.addEventListener("click", (e) => {
      ...
      switch (elementId) {
        case "1": // Peaceful Piano
          window.open(
            "https://open.spotify.com/playlist/51FY41cuYWtjoeuY90aTkw?si=1101d1a908434425",
            "_blank"
          );
          break;
        case "2": // Elegant Jazz
          window.open(
            "https://open.spotify.com/playlist/3OHE3VO1SApjBBqBc5ns8v?si=4445c994fce241d3",
            "_blank"
          );
          break;
        case "3": // Lofi Dreams
          window.open(
            "https://open.spotify.com/playlist/5FmNVvu1pSFCXSVSzQH9pr?si=7e7be45d6b404642",
            "_blank"
          );
          break;
        case "modal1": // White Noise
          window.open(
            "https://open.spotify.com/playlist/0ki4X4mN7ggUrYcvvv6pq1?si=df0f61d8d91741c6",
            "_blank"
          );
          break;
        case "modal2": // Brown Noise
          window.open(
            "https://open.spotify.com/playlist/3TPmuEYCxb84sRYH4KXPiF?si=b0fc2132a1cd4e26",
            "_blank"
          );
          break;
        case "modal3": // Pink Noise
          window.open(
            "https://open.spotify.com/playlist/606f0E4BDtBtWAO9SjO7BM?si=00a8c1e6235d4d17",
            "_blank"
          );
          break;
        case "modal4": // Forest
          window.open(
            "https://open.spotify.com/playlist/4J9hDxbs08490A7BDS52lw?si=9fe35ff1a6f54781",
            "_blank"
          );
          break;
        case "modal5": // Creek
          window.open(
            "https://open.spotify.com/playlist/4W7cNRDkx2I3Swy6zQtnMl?si=d335ca40e2614d8a",
            "_blank"
          );
          break;
        case "modal6": // Rain
          window.open(
            "https://open.spotify.com/playlist/6eAkOpgDdauoC53IBkMKkD?si=613c0cdb4d5842e9",
            "_blank"
          );
          break;
        case "modal7": // Thunder
          window.open(
            "https://open.spotify.com/playlist/2ivC5Xlo0rXsUM8j38vufy?si=4be0794be7ee4479",
            "_blank"
          );
          break;
      }
    ...
    youtubeIcon.addEventListener("click", (e) => {
      ...
      switch (elementId) {
        case "1": // Peaceful Piano
          window.open(
            "https://music.youtube.com/playlist?list=PLbeAGNc9R54fayVupFaxlfRU91v6xQw_a",
            "_blank"
          );
          break;
        case "2": // Elegant Jazz
          window.open(
            "https://music.youtube.com/playlist?list=PLbeAGNc9R54dENbyCekPMHI9Ptt95zHFD&feature=shared",
            "_blank"
          );
          break;
        case "3": // Lofi Dreams
          window.open(
            "https://music.youtube.com/playlist?list=PLbeAGNc9R54f524vMstaf4GTPpoTQF1SP&feature=shared",
            "_blank"
          );
          break;
        case "modal1": // White Noise
          window.open(
            "https://music.youtube.com/playlist?list=PLbeAGNc9R54fYV6kSiwRr74EvtwlBSA5c&feature=shared",
            "_blank"
          );
          break;
        case "modal2": // Brown Noise
          window.open(
            "https://music.youtube.com/playlist?list=PLbeAGNc9R54d82SmgIUMQcVj6-2TtSaQS&feature=shared",
            "_blank"
          );
          break;
        case "modal3": // Pink Noise
          window.open(
            "https://music.youtube.com/playlist?list=PLbeAGNc9R54fIynp_4WdkFwE1fcFXszTb&feature=shared",
            "_blank"
          );
          break;
        case "modal4": // Forest
          window.open(
            "https://music.youtube.com/playlist?list=PLbeAGNc9R54fhassniXp2M_P_KxerUBqw&feature=shared",
            "_blank"
          );
          break;
        case "modal5": // Creek
          window.open(
            "https://music.youtube.com/playlist?list=PLbeAGNc9R54cwstgvj1FQAwZWzo9uKeAr&feature=shared",
            "_blank"
          );
          break;
        case "modal6": // Rain
          window.open(
            "https://music.youtube.com/playlist?list=PLbeAGNc9R54cLk4ygJ5ES4VH-_RV7Q-Ys&feature=shared",
            "_blank"
          );
          break;
        case "modal7": // Thunder
          window.open(
            "https://music.youtube.com/playlist?list=PLbeAGNc9R54cZqRKtnHLfkq92h-2TSBYG&feature=shared",
            "_blank"
          );
          break;
      }
    ...
    appleIcon.addEventListener("click", (e) => {
      ...
      switch (elementId) {
        case "1": // Peaceful Piano
          window.open(
            "https://music.apple.com/no/playlist/peaceful-piano/pl.u-oZylD6gsGlJWPP3",
            "_blank"
          );
          break;
        case "2": // Gentle Jazz
          window.open(
            "https://music.apple.com/no/playlist/gentle-jazz/pl.u-xlyNE32CJDL4XXA",
            "_blank"
          );
          break;
        case "3": // Lofi Dreams
          window.open(
            "https://music.apple.com/no/playlist/lofi-dreams/pl.u-kv9l2aJTJVZrXXv",
            "_blank"
          );
          break;
        case "modal1": // White Noise
          window.open(
            "https://music.apple.com/no/playlist/white-noise/pl.u-KVXBkPPFLRWrzzv",
            "_blank"
          );
          break;
        case "modal2": // Brown Noise
          window.open(
            "https://music.apple.com/no/playlist/brown-noise/pl.u-8aAVZy9IvL2zNNX",
            "_blank"
          );
          break;
        case "modal3": // Pink Noise
          window.open(
            "https://music.apple.com/no/playlist/pink-noise/pl.u-oZylD0lTGlJWPP3",
            "_blank"
          );
          break;
        case "modal4": // Forest
          window.open(
            "https://music.apple.com/no/playlist/relaxing-forest-ambience/pl.u-oZylD1esGlJWPP3",
            "_blank"
          );
          break;
        case "modal5": // Creek
          window.open(
            "https://music.apple.com/no/playlist/soothing-creek-sounds/pl.u-WabZv4PSel2aWWE",
            "_blank"
          );
          break;
        case "modal6": // Rain
          window.open(
            "https://music.apple.com/no/playlist/gentle-rainstorm-sounds/pl.u-8aAVZ5jHvL2zNNX",
            "_blank"
          );
          break;
        case "modal7": // Thunder
          window.open(
            "https://music.apple.com/no/playlist/relaxing-thunderstorm-sounds/pl.u-NpXmze4t4gKovvl",
            "_blank"
          );
          break;
      }
...
document.addEventListener("scroll", () => {
  ...
  const maxScroll = bottomSection.offsetTop + 50;

  if (window.scrollY > maxScroll) {
    window.scrollTo(0, maxScroll); // Enkel og rask fallback uten smooth scroll
  }
});
